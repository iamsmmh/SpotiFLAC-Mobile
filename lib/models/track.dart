...
class Track {
  ...
  factory Track.fromBackendMap(
    ...
    return Track(
      ...
      trackNumber: readPositiveInt(data['track_number']),
      discNumber: readPositiveInt(data['disc_number']),
      totalDiscs: readPositiveInt(data['total_discs']),
      releaseDate: data['release_date']?.toString(),
      totalTracks: readPositiveInt(data['total_tracks']),
