...
class DownloadService : Service() {
    ...
    companion object {
        ...
        const val ACTION_START = "com.zarz.spotimusic.action.START_DOWNLOAD"
        const val ACTION_STOP = "com.zarz.spotimusic.action.STOP_DOWNLOAD"
        const val ACTION_UPDATE_PROGRESS = "com.zarz.spotimusic.action.UPDATE_PROGRESS"
        const val ACTION_START_NATIVE_QUEUE = "com.zarz.spotimusic.action.START_NATIVE_QUEUE"
        const val ACTION_PAUSE_NATIVE_QUEUE = "com.zarz.spotimusic.action.PAUSE_NATIVE_QUEUE"
        const val ACTION_RESUME_NATIVE_QUEUE = "com.zarz.spotimusic.action.RESUME_NATIVE_QUEUE"
        const val ACTION_CANCEL_NATIVE_QUEUE = "com.zarz.spotimusic.action.CANCEL_NATIVE_QUEUE"
